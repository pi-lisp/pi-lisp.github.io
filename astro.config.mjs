...
export default defineConfig({
    integrations: [
        starlight({
            ...
            lastUpdated: true,
            editLink: {
                baseUrl: 'https://github.com/uwulisp/uwulisp.github.io/edit/main/',
            },
            logo: {
            ...
            social: [
                { icon: 'github', label: 'GitHub', href: 'https://github.com/uwulisp/uwulisp' },
            ],
            ...
            sidebar: [
                ...
                { label: 'Grammar Reference', slug: 'document' },
                {
                    ...
                    items: [
                        ...
                        { label: 'Cubical Type Theory', slug: 'builtins/cubical' },
